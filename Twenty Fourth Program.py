...
start_button = tk.Button(text='START', height=5, width=7, font=('FORTE', 20), command=start)
start_button.pack(side=tk.LEFT)
pause_button = tk.Button(text='PAUSE', height=5, width=7, font=('FORTE', 20), command=pause)
pause_button.pack(side=tk.LEFT)
reset_button = tk.Button(text='RESET', height=5, width=7, font=('FORTE', 20), command=reset)
reset_button.pack(side=tk.LEFT)
quit_button = tk.Button(text='QUIT', height=5, width=7, font=('forte', 20), command=root.quit)
